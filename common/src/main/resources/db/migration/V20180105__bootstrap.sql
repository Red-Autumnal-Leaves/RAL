...
CREATE TABLE `catalog` (
  ...
  `logo` BIGINT NOT NULL DEFAULT '0' COMMENT 'logo图片,指向图片表',
...
CREATE TABLE `brand` (
  ...
  `logo` BIGINT NOT NULL DEFAULT '0' COMMENT 'logo图片,指向图片表',
  `category_id` BIGINT NOT NULL DEFAULT '0' COMMENT '类目',
  `create_user` varchar(30) NOT NULL DEFAULT '' COMMENT '创建者',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `last_update_user` varchar(30) NOT NULL DEFAULT '' COMMENT '最后修改者',
  `last_update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
...
CREATE TABLE `item` (
  ...
  `category_id` BIGINT NOT NULL DEFAULT '0' COMMENT '基础分类ID',
  `catalog_id` BIGINT NOT NULL COMMENT '目录ID',
  `brand_id` BIGINT NOT NULL DEFAULT '0' COMMENT '品牌Id',
  `image_id` BIGINT NOT NULL DEFAULT '0' COMMENT '橱窗图,指向图片表',
...
CREATE TABLE `spec_value` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `spec_id` BIGINT NOT NULL DEFAULT 0 COMMENT '属性ID',
...
CREATE TABLE `sku_spec` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `sku_code` varchar(30) NOT NULL DEFAULT '' COMMENT '规格编码',
  `spec_value_id` BIGINT NOT NULL DEFAULT '0' COMMENT '值表Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
CREATE TABLE `sku_stock_log` (
  ...
  `type` int DEFAULT 0 not NULL COMMENT '操作类型',
  `item_code` varchar(50) NOT NULL DEFAULT '' COMMENT '商品编码',
  `sku_code` varchar(50) NOT NULL DEFAULT '' COMMENT '商品编码',
...
CREATE TABLE `evaluate` (
  ...
  `member_id` BIGINT NOT NULL DEFAULT '0' COMMENT '用户',
  `create_user` varchar(30) NOT NULL DEFAULT '' COMMENT '创建者',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `last_update_user` varchar(30) NOT NULL DEFAULT '' COMMENT '最后修改者',
  `last_update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
...
CREATE TABLE `evaluate_image` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `evaluate_id` BIGINT NOT NULL DEFAULT 0 COMMENT '评价ID',
  `image` BIGINT NOT NULL DEFAULT '1' COMMENT '图片',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `is_disable` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE `express` (
  ...
  `is_disable` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='快递类型表';
...
CREATE TABLE `sales_order` (
  ...
  `express_id` BIGINT NOT NULL DEFAULT '0' COMMENT '快递Id',
...
CREATE TABLE `order_payment` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `sales_order_no` varchar(30) NOT NULL DEFAULT '' COMMENT '订单号',
  `pay_method_id` BIGINT NOT NULL DEFAULT '0' COMMENT '支付方式',
...
CREATE TABLE `member` (
  ...
  `header` BIGINT NOT NULL DEFAULT 0 COMMENT '头像',
  `integral` int(10) NOT NULL DEFAULT '0' COMMENT '积分',
  `member_type` BIGINT NOT NULL DEFAULT '0' COMMENT '会员级别',
...
CREATE TABLE `member_type` (
  ...
  `icon` BIGINT NOT NULL DEFAULT 0 COMMENT '基本logo',
